...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_14b73d0966098d493ca0689a3a86564326').trim(),
  DATABASE:
  ...
  LIST_TYPE: (process.env.LIST_TYPE || 'pool').trim(),
  BING_COOKIE: (process.env.BING_COOKIE || '').trim(),
  GEMINI_API_KEY: (process.env.GEMINI_API_KEY || '').trim(),
  GROUP_ADMINS: process.env.GROUP_ADMINS || 'public',
